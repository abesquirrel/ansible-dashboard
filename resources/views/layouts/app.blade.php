...
<head>
    ...
    <title>@yield('title', 'Ansible Dashboard') · CTRL</title>
...
<div class="app-shell">
    ...
    <header class="topbar">
        ...
        @if(isset($connectionStatus['ansible_version']))
            ...
            <span style="font-family:var(--font-mono);font-size:11px;color:var(--text-muted)">
                {{ $connectionStatus['ansible_version'] }}
            </span>
        @endif

        <div class="topbar-right">
            <a href="{{ route('terminal.index') }}" class="btn-topbar">
    ...
    <nav class="sidebar">
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('playbooks.index') }}" class="sidebar-link {{ request()->routeIs('playbooks.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('terminal.index') }}" class="sidebar-link {{ request()->routeIs('terminal.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/>
                </svg>
                Terminal
        ...
        <div class="sidebar-section">
            <div class="sidebar-label">Learning Hub</div>
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('logs.jobs') }}" class="sidebar-link {{ request()->routeIs('logs.jobs') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
                </svg>
                Job History
                @php $running = \App\Models\PlaybookJob::whereIn('status',['queued','running'])->count(); @endphp
                @if($running > 0)
                    <span class="sidebar-badge running">{{ $running }}</span>
                @endif
            </a>
            <a href="{{ route('logs.index') }}" class="sidebar-link {{ request()->routeIs('logs.index') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
