...
<div class="page-body">
    <div class="grid-2 gap-4" style="gap:24px;align-items:start">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('settings.env')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label class="form-label">Control Node Host</label>
                        <input type="text" name="ANSIBLE_SSH_HOST" class="form-input" value="<?php echo e($settings['ssh_host']); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">SSH Port</label>
                        <input type="number" name="ANSIBLE_SSH_PORT" class="form-input" value="<?php echo e($settings['ssh_port']); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">SSH User</label>
                        <input type="text" name="ANSIBLE_SSH_USER" class="form-input" value="<?php echo e($settings['ssh_user']); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Auth Method</label>
                        <div class="code-block" style="font-size:12px"><?php echo e($settings['ssh_auth_method'] === 'key' ? 'SSH Key (ANSIBLE_SSH_KEY_PATH)' : 'Password (ANSIBLE_SSH_PASSWORD)'); ?></div>
                        <div class="form-hint">Edit ANSIBLE_SSH_KEY_PATH or ANSIBLE_SSH_PASSWORD in .env directly</div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Working Directory</label>
                        <input type="text" name="ANSIBLE_WORKING_DIR" class="form-input" value="<?php echo e($settings['working_dir']); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Default Inventory Path</label>
                        <input type="text" name="ANSIBLE_INVENTORY_DEFAULT" class="form-input" value="<?php echo e($settings['inventory']); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Playbooks Directory</label>
                        <input type="text" name="ANSIBLE_PLAYBOOKS_DIR" class="form-input" value="<?php echo e($settings['playbooks_dir']); ?>">
                    </div>
                ...
                <div class="card-body">
                    <div style="display:grid;gap:10px">
                        <div class="flex gap-2">
                            ...
                            <span class="text-mono text-sm"><?php echo e(app()->version()); ?></span>
                        </div>
                        <div class="flex gap-2">
                            <span class="form-label" style="margin:0;width:140px">PHP</span>
                            <span class="text-mono text-sm"><?php echo e(PHP_VERSION); ?></span>
                        </div>
                        <div class="flex gap-2">
                            <span class="form-label" style="margin:0;width:140px">Queue Driver</span>
                            <span class="text-mono text-sm"><?php echo e(config('queue.default')); ?></span>
                        </div>
                        <div class="flex gap-2">
                            <span class="form-label" style="margin:0;width:140px">Broadcast</span>
                            <span class="text-mono text-sm"><?php echo e(config('broadcasting.default')); ?></span>
                        </div>
                        <div class="flex gap-2">
                            <span class="form-label" style="margin:0;width:140px">Environment</span>
                            <span class="text-mono text-sm"><?php echo e(app()->environment()); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/paul/Git/ansible-dashboard/resources/views/settings/index.blade.php ENDPATH**/ ?>